    ...
    <section className="relative flex min-h-[900px] w-full flex-col items-center justify-center overflow-hidden bg-[#000000] py-20 border-t border-neutral-900">
      ...
      <div className="z-10 text-center px-4 w-full flex flex-col items-center">
        ...
        <h2 className="text-4xl md:text-7xl font-bold font-space text-white mb-6 drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">
          The Central <span className="text-neon-cyan drop-shadow-[0_0_20px_rgba(0,240,255,0.8)]">Command</span>
        </h2>
        
        <p ref={textRef} className="mx-auto mt-6 max-w-2xl text-xl text-neutral-400 leading-relaxed font-mono-tech">
          Abstract away the complexity of AWS, GCP, and Azure. Manage your entire stack from a single, secure, transparent pane of glass.
        </p>
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8 h-[calc(100%-3.5rem)] transform-style-3d">
                ...
                <div className="col-span-2 rounded-xl bg-linear-to-br from-neutral-900/80 to-[#060318]/90 border border-blue-900/40 relative overflow-hidden transition-transform duration-500 group-hover:translate-z-[80px] shadow-[0_20px_40px_rgba(0,0,0,0.6)] flex flex-col p-6">
                  <div className="flex justify-between items-center w-full mb-8">
                      <span className="text-white font-bold font-space text-xl">Global Routing Traffic</span>
                      <span className="text-neon-emerald font-mono-tech bg-neon-emerald/10 px-3 py-1 rounded-full text-xs border border-neon-emerald/30 glow">+24.5% Online</span>
                  </div>
                  ...
                  <div className="flex-1 w-full border-b border-l border-neutral-800 flex items-end relative overflow-hidden">
                     <svg className="absolute inset-0 w-full h-full drop-shadow-[0_0_15px_rgba(0,240,255,0.8)]" preserveAspectRatio="none" viewBox="0 0 100 100">
                        <defs>
                        ...
                        <path d="M0 100 C 20 80, 40 90, 60 50 S 80 40, 100 10 L 100 100 Z" fill="url(#gradCyan)" opacity="0.15"/>
                        <path d="M0 100 C 30 60, 50 110, 70 40 S 90 20, 100 30 L 100 100 Z" fill="url(#gradCyan)" opacity="0.1"/>

                        {/* Animated Curvey Data Streams */}
                        <path className="data-stream" d="M0 100 C 20 80, 40 90, 60 50 S 80 40, 100 10" fill="none" stroke="#00F0FF" strokeWidth="1.5" strokeDashoffset="200" />
                        <path className="data-stream-2" d="M0 100 C 30 60, 50 110, 70 40 S 90 20, 100 30" fill="none" stroke="url(#gradPurple)" strokeWidth="2" strokeDashoffset="250" />
                        <path className="data-stream-3" d="M0 80 Q 25 10, 50 60 T 100 20" fill="none" stroke="#00FFA3" strokeWidth="1" opacity="0.7" strokeDashoffset="300" />
                     </svg>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-8 transform-style-3d">
                  ...
                  <div className="flex-1 rounded-xl bg-linear-to-br from-neutral-900/80 to-[#060318]/90 border border-purple-900/40 flex flex-col p-6 transition-transform duration-500 group-hover:translate-z-[120px] shadow-[0_20px_40px_rgba(0,0,0,0.6)]">
                    <span className="text-white font-bold font-space text-lg mb-4">Active Compute Nodes</span>
                    <div className="flex items-end gap-2 mt-auto">
                        <span className="text-5xl font-extrabold text-neon-cyan tracking-tighter drop-shadow-[0_0_10px_rgba(0,240,255,0.5)]">1,402</span>
                  ...
                  <div className="flex-1 rounded-xl bg-linear-to-br from-neutral-900/80 to-[#060318]/90 border border-neutral-800/80 p-6 flex flex-col transition-transform duration-500 group-hover:translate-z-[60px] shadow-[0_20px_40px_rgba(0,0,0,0.6)]">
                    <span className="text-neutral-400 font-bold font-space text-sm uppercase tracking-wider mb-4">Live Deployments</span>
