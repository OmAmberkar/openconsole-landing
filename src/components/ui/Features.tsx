...
const features = [
  {
    ...
    description:
      'Control AWS, GCP, and Azure from a single pane of glass with unified IAM handling.',
  },
  {
    icon: Zap,
    title: 'Lightning Provisioning',
    description:
      'Deploy complex infrastructure stacks across regions in under 60 seconds relying on Edge architecture.',
  },
  {
    icon: Search,
    title: 'Global Resource Search',
    description:
      'Instantly locate any server, database, or lambda function across all your connected clouds.',
  },
  {
    icon: Shield,
    title: 'Unified Complaince',
    description:
      'Enforce SOC2, HIPAA, and custom security policies natively across every provider automatically.',
  },
  {
    icon: Database,
    title: 'Cost Intelligence',
    description:
      'Identify unattached EBS volumes, idle DBs, and wasted resources with AI-driven insights.',
  },
  {
    icon: Network,
    title: 'VPC Peering Automized',
    description:
      'Connect VPCs across different cloud providers with single-click dedicated networking.',
  },
];
...
export default function Features() {
  ...
  return (
    <section
      id='features'
      ref={containerRef}
      className='relative py-24 md:py-32 w-full bg-[#000000] overflow-hidden'
    >
      ...
      <div className='container mx-auto px-4 max-w-7xl relative z-10'>
        <div className='text-center mb-16 md:mb-24'>
          ...
          <p className='text-xl text-neutral-400 font-mono-tech max-w-2xl mx-auto'>
            Everything you need to scale infrastructure dynamically without the AWS Management
            Console headache.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className='gsap-feature-card group relative h-full interactive'>
                {/* 
