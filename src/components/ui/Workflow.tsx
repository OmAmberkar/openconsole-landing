        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-16 relative z-10">
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="workflow-step flex flex-col md:flex-row items-center gap-8 md:gap-12">
                  
                  {/* Icon Node */}
                  <div className={`shrink-0 w-24 h-24 rounded-full flex items-center justify-center bg-[#0a0528] border ${step.border} z-10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] interactive`}>
                  ...
                  <div className="glass-pane p-8 rounded-2xl w-full max-w-xl group hover:border-cyan-500/50 transition-colors duration-500">
                    ...
                    <p className="text-neutral-400 font-mono-tech leading-relaxed">
                      {step.desc}
                    </p>
                  </div>
