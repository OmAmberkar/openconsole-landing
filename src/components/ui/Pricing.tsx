        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-center mt-12'>
          {tiers.map((tier, index) => (
            ...
            >
              ...
              <div
                className={`h-full bg-[#060318] rounded-[calc(1.5rem-2px)] p-8 flex flex-col ${tier.isPopular ? 'shadow-[0_0_30px_rgba(112,0,255,0.2)]' : ''}`}
              >
                ...
                <div className='my-8'>
                  ...
                  {tier.period && (
                    <span className='text-neutral-500 font-mono-tech ml-2'>{tier.period}</span>
                  )}
                </div>
                ...
                <ul className='flex flex-col gap-4 mb-10 grow'>
                  {tier.features.map((feature, idx) => (
                    <li key={idx} className='flex items-start gap-3'>
                      ...
                      <span className='text-neutral-300 font-mono-tech text-sm leading-relaxed'>
                        {feature}
                      </span>
                    </li>
                  ))}
                ...
                <button
                  className={`w-full py-4 rounded-xl font-bold transition-all duration-300 font-space tracking-wide
                   ${
                     tier.isPopular
