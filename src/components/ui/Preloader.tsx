    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        <div className="relative w-24 h-24 flex items-center justify-center">
          {/* Rotating Rings */}
          <div className="absolute inset-0 rounded-full border-t-2 border-l-2 border-cyan-400 animate-spin" style={{ animationDuration: '2s' }}></div>
          ...
          <span ref={percentRef} className="text-2xl font-bold text-white shadow-cyan-400 drop-shadow-md">0</span>
          <span className="text-sm absolute -right-4 top-4">%</span>
        </div>

        <div ref={textRef} className="text-sm tracking-widest text-center uppercase drop-shadow-[0_0_8px_rgba(0,240,255,0.8)]">
          {loadingText}
