...
// 3. Magnetic Button
export const useMagneticButton = (buttonRef: React.RefObject<HTMLElement | null>, radius: number = 50) => {
  useGSAP(() => {
...
export const useFeaturesStagger = (containerRef: React.RefObject<HTMLDivElement | null>, cardSelector: string) => {
  useGSAP(() => {
...
export const useSvgPathAnimation = (svgRef: React.RefObject<SVGSVGElement | null>, pathSelector: string) => {
  useGSAP(() => {
...
export const useFooterStagger = (footerRef: React.RefObject<HTMLElement | null>, colSelector: string) => {
  useGSAP(() => {
