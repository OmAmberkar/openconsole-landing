    ...
    <div ref={containerRef} className='relative bg-[#000000] selection:bg-cyan-500/30'>
      ...
      <div className='min-h-screen text-white overflow-hidden font-space relative'>
        ...
        <div className='fixed inset-0 z-0 pointer-events-none'>
          ...
          <div
            ref={gridRef}
            className='absolute inset-0 opacity-[0.15] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size[60px_60px]'
          ></div>

          {/* Secondary Faster Grid (Depth) */}
          <div
            ref={secondaryGridRef}
            className='absolute inset-0 opacity-[0.05] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size[120px_120px] transform scale-150'
          ></div>
          ...
          <header className='absolute top-8 left-1/2 -translate-x-1/2 z-100 border rounded-full drop-shadow-[0_0_8px_rgba(0,0,0,0.9)]'>
            <div className='flex items-center gap-6 px-8 py-3 rounded-full border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_0_30px_rgba(0,0,0,0.5)]'>
              ...
              <div className='ml-4 flex items-center gap-2 pl-4 border-l border-white/10'>
                ...
                <span className='text-[10px] font-mono text-cyan-400/70 tracking-tighter'>
                  LINK_STABLE
                </span>
              </div>
            </div>
          ...
          <main className='relative pt-32 pb-20 px-4 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-screen'>
            ...
            <div className='text-center'>
              ...
              <h1 className='text-6xl md:text-[10rem] font-bold tracking-tighter mb-8 leading-[0.85] text-white'>
                ...
                <span className='bg-linear-to-r from-cyan-400 via-white to-purple-500 text-transparent bg-clip-text'>
                  {' '}
                  CLOUD
                </span>
              </h1>
              ...
              <p className='text-lg md:text-xl text-neutral-400 mb-12 max-w-xl mx-auto font-light leading-relaxed tracking-tight'>
                A high-performance control plane for{' '}
                <span className='text-white border-b border-white/20'>multi-cloud</span>{' '}
                environments. Zero latency. Infinite scale.
              </p>
                ...
                <div className='flex gap-6 items-center'>
                  <div className='flex -space-x-3'>
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className='w-8 h-8 rounded-full border-2 border-black bg-neutral-800'
                      />
                    ))}
                  </div>
